...
namespace AnimeTracker.Controllers
{
    public class AnimeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Title,Genre,Episodes,Status,Rating,Notes")] Anime anime)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Genre,Episodes,Status,Rating,Notes,DateAdded")] Anime anime)
        {
